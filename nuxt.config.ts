...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      script: [
        {
          src: 'https://www.googletagmanager.com/gtag/js?id=G-70K83WEHD5',
          async: true
        },
        {
          innerHTML: `
      ...
      noscript: [
        {
          innerHTML: '<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=2202785866782399&ev=PageView&noscript=1" />'
        }
      ]
    }
  }
